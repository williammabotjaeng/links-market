        ...
        <div class="column is-half">
            <div class="card has-text-white" style="background-color: #008c8c">
                <div class="card-content">
                    ...
                    <p class="mb-1">The bonus balance represents additional funds awarded as a reward for exceptional performance, special achievements, or participation in specific activities. Unlike regular earnings, which are typically tied to standard tasks or responsibilities, the bonus balance serves as an incentive for individuals.</p>
        ...
        <div class="column is-half">
            <div class="card has-background-grey has-text-white">
                <div class="card-content">
                    ...
                    <p class="subtitle is-6">$0</p>
                    <p class="mb-1">Funds that have been reserved as a task payment</p>
