<nav class="navbar has-shadow" role="navigation" aria-label="main navigation" style="background-color: rgba(220, 248, 248, 0.6); border-bottom: 1px dotted rgba(0, 140, 140, 0.5)">
